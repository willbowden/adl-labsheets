...
def main(args):
    ...
    trainer = Trainer(
        model, train_loader, test_loader, criterion, optimizer, summary_writer, DEVICE, scheduler=scheduler
    )
...
class CNN(nn.Module):
    def __init__(self, height: int, width: int, channels: int, class_count: int):
        ...
        self.batch3 = nn.BatchNorm1d(num_features=1024)
...
def compute_accuracy(
    ...
    """
    Args:
        labels: ``(batch_size, r(xclass_count)`` tensor or array containing example labels
...
def get_summary_writer_log_dir(args: argparse.Namespace) -> str:
    ...
    Returns:
        ...
        untangle in TB).
    """
    tb_log_dir_prefix = f'CNN_bn_bs={args.batch_size}_lr={args.learning_rate}_momentum=0.9_stepLR_run_'
    i = 0
    while i < 1000:
